...
validate_test() ->
    ...
    ?assertMatch(ok, coffer_blob:validate_blobref(<<"hashtype-bad">>)),
...
parse_test() ->
    ...
    ?assertMatch(ok, coffer_blob:parse_blobref(<<"hashtype-bad">>)),
    ?assertMatch(error, coffer_blob:parse_blobref(<<"bad">>)),
    ?assertMatch(error, coffer_blob:parse_blobref(<<"-bad">>)).

blob_path_test() ->
    ?assertMatch(<<"/hash/a/b/c/d">>,
                 coffer_blob:blob_path("/", "hashtype-abcd")),
    ?assertMatch(<<"/root/hash/a/b/c/d">>,
                 coffer_blob:blob_path("/root", "hashtype-abcd")),
    ?assertMatch(error, coffer_blob:blob_path("/", "hashtype-abc")).
